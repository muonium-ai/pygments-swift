...
final class LexerRegistryTests: XCTestCase {
    func testMakeLexerByName() {
        ...
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "ini"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "dotenv"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "env"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "gherkin"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "feature"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "vue"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "svelte"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "hjson"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "kdl"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "bicep"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "dhall"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "kusto"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "kql"))

        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "procfile"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "psql"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "applescript"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "abap"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "apl"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "aspectj"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "autoit"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "antlr"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "antlr-java"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "angular2"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "shell-session"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "reg"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "slim"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "dtd"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "cfml"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "chai"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "aspx"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "gnuplot"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "foxpro"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "basic"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "pov"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "plpgsql"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "openscad"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "mojo"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "liquid"))
        XCTAssertNotNil(LexerRegistry.makeLexer(languageName: "text"))
    ...
    func testMakeLexerByFilename() {
        ...
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "Procfile"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.psql"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.applescript"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.abap"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.apl"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.au3"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "Grammar.g"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "fibonacci.angular.ng2"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "fibonacci.sh-session"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "registry.reg"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "view.slim"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "doctype.dtd"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "view.cfml"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.chai"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "page.aspx"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "chart.plt"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "program.prg"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "program.bas"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "scene.pov"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "model.scad"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "script.mojo"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "theme.liquid"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "notes.txt"))
        ...
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "config.ini"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "app.env"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: ".env"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "spec.feature"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "Component.vue"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "Component.svelte"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "data.hjson"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "config.kdl"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "main.bicep"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "config.dhall"))
        XCTAssertNotNil(LexerRegistry.makeLexer(filename: "query.kql"))
